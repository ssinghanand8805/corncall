...
import 'package:corncall/Services/Providers/FirebaseAPIProvider.dart';
        ...
        await FirebaseFirestore.instance
          ...
          try {
            ...
            // if (encrypted is String) {
              ...
              if (content.trim() != '') {
                var chatId = Corncall.getChatId(currentUserNo, peer);
                await FirebaseFirestore.instance
                    .collection(DbPaths.collectionbroadcasts)
                    .doc(broadcastId)
                    .collection(DbPaths.collectionbroadcastsChats)
            ...
            Corncall.toast('Failed to Send message. Error:$e');
          }
        }).catchError(((e) {
          Corncall.toast('Failed to Send message. Error:$e');
        }));
