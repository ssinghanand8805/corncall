...
import 'package:corncall/Screens/homepage/initialize.dart';
...
import 'package:corncall/Services/Providers/LazyLoadingChatProvider.dart';
...
import 'package:corncall/Services/localization/demo_localization.dart';
import 'package:corncall/Services/localization/language_constants.dart';
import 'package:corncall/Services/Providers/DownloadInfoProvider.dart';
...
void main() async {
  ...
  SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp])
      .then((_) {
    runApp(OverlaySupport(child: CorncallWrapper()));
  });
}

class CorncallWrapper extends StatefulWidget {
  const CorncallWrapper({Key? key}) : super(key: key);
  static void setLocale(BuildContext context, Locale newLocale) {
    _CorncallWrapperState state =
    context.findAncestorStateOfType<_CorncallWrapperState>()!;
    state.setLocale(newLocale);
  }

  @override
  _CorncallWrapperState createState() => _CorncallWrapperState();
}

class _CorncallWrapperState extends State<CorncallWrapper> {
                    ...
                    return MultiProvider(
                      ...
                      child: MaterialApp(
                          theme: ThemeData(
                              ...
                              primaryColor: corncallPRIMARYcolor,
                              primaryColorLight: corncallPRIMARYcolor,
