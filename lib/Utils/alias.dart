...
class _AliasFormState extends State<AliasForm> {
  ...
  void initState() {
    super.initState();
    _alias =
        new TextEditingController(text: Corncall.getNickname(widget.user));
  }
  ...
  Widget build(BuildContext context) {
    String? name = Corncall.getNickname(widget.user);
    return AlertDialog(
      ...
      actions: <Widget>[
        ...
        ElevatedButton(
            ...
            child: Text(
              ...
              style: TextStyle(
                  fontWeight: FontWeight.bold, color: corncallPRIMARYcolor),
            ),
            onPressed: () {
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
              ...
              child: Stack(children: [
                Center(
                    child: Corncall.avatar(widget.user,
