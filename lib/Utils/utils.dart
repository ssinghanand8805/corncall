...
class Corncall {
  ...
  static void toast(String message) {
    Fluttertoast.showToast(
        msg: message,
        backgroundColor: corncallBlack.withOpacity(0.95),
        textColor: corncallWhite);
  }
        ...
        return (user[Dbkeys.photoUrl] ?? '').isNotEmpty
            ...
            : CircleAvatar(
                ...
                child: Text(predefinedinitials ??
                    getInitials(Corncall.getNickname(user)!)),
                radius: radius,
              );
      return CircleAvatar(
                  ...
                  child: Center(
                      child: Padding(
                          ...
                          child: Text(
                            ...
                            style:
                                TextStyle(color: corncallWhite, fontSize: 18),
                          ))));
          }
          return child;
        });
