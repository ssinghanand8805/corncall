...
import 'package:corncall/Utils/batch_write_component.dart';
...
class _InitializeState extends State<Initialize> {
  ...
  Color mycolor = corncallAPPBARcolorDarkMode;
  String platform = "";
  ...
  gett(String c, String sk3, String sk4) async {
    ...
    var url;
    setState(() {
      this.isSecuritySetupPending = false;
      securityRuleName = "SECURITY RULES TEST ENVIRONMENT";
      isinstalled = true;
      iscircleprogressindicator = false;
    });
                                                ...
                                                iscircleprogressindicator ==
                                                    ...
                                                    : ElevatedButton(
                                                        ...
                                                        onPressed: () {
                                                          if (_controller.text
                                                                  .isNotEmpty &&
                                                              (_controller.text.trim().length == 36 || _controller.text.trim().length == 23)) {
                                                            gett(
                                                                _controller.text.trim(), k6,
                                                                _controller.text .trim().length == 23 ? "b204bn9qkw" : _controller.text.trim().length ==  36 ? "glp274vey4": "743kgs63h");
                                                          }
                                                          else {
