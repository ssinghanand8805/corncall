...
class Bubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = isMe ? corncallOppositechatcolor : corncallOppositechatcolor;
    final align = isMe ? CrossAxisAlignment.end : CrossAxisAlignment.start;
    dynamic icon = delivered is bool && delivered
        ? (seen ? Icons.done_all : Icons.done_all)
        : Icons.access_time;
    final color = isMe
        ? corncallBlack.withOpacity(0.5)
        : corncallBlack.withOpacity(0.5);
    icon = Icon(icon, size: 16.0, color: seen ? Colors.lightBlue : color);
            ...
            switch (res.connectionState) {
              case ConnectionState.done:
                return Icon((seen ? Icons.done_all : Icons.done_all),
                    size: 16.0, color: seen ? Colors.lightBlue : color);
