...
import 'package:corncall/widgets/AllinOneCameraGalleryImageVideoPicker/AllinOneCameraGalleryImageVideoPicker.dart';
import 'package:corncall/widgets/CameraGalleryImagePicker/camera_image_gallery_picker.dart';
import 'package:corncall/widgets/CameraGalleryImagePicker/multiMediaPicker.dart';
import 'package:corncall/widgets/DownloadManager/download_all_file_type.dart';
import 'package:corncall/widgets/VideoEditor/video_editor.dart';
...
import 'package:corncall/Screens/chat_screen/utils/uploadMediaWithProgress.dart';
import 'package:corncall/Screens/contact_screens/SelectContactsToForward.dart';
import 'package:corncall/Screens/security_screens/security.dart';
import 'package:corncall/Services/Admob/admob.dart';
import 'package:corncall/Utils/emoji_detect.dart';
import 'package:corncall/Utils/mime_type.dart';
import 'package:corncall/main.dart';
import 'package:corncall/widgets/CountryPicker/CountryCode.dart';
import 'package:corncall/Configs/Dbkeys.dart';
import 'package:corncall/Configs/Dbpaths.dart';
import 'package:corncall/Screens/chat_screen/utils/deleteChatMedia.dart';
...
import 'package:corncall/widgets/MultiDocumentPicker/multiDocumentPicker.dart';
import 'package:corncall/widgets/MyElevatedButton/MyElevatedButton.dart';
import 'package:corncall/widgets/SoundPlayer/SoundPlayerPro.dart';
...
import 'package:corncall/Screens/chat_screen/utils/audioPlayback.dart';
import 'package:corncall/Screens/chat_screen/utils/message.dart';
import 'package:corncall/Screens/contact_screens/ContactsSelect.dart';
import 'package:corncall/Models/DataModel.dart';
import 'package:corncall/Screens/chat_screen/utils/photo_view.dart';
import 'package:corncall/Screens/profile_settings/profile_view.dart';
import 'package:corncall/Services/Providers/seen_provider.dart';
import 'package:corncall/Services/Providers/seen_state.dart';
...
import 'package:corncall/Utils/crc.dart';
import 'package:corncall/Utils/open_settings.dart';
import 'package:corncall/Utils/save.dart';
import 'package:corncall/Utils/utils.dart';
import 'package:corncall/widgets/AudioRecorder/Audiorecord.dart';
import 'package:corncall/widgets/ImagePicker/image_picker.dart';
import 'package:corncall/widgets/VideoPicker/VideoPreview.dart';
import 'package:corncall/Screens/chat_screen/Widget/bubble.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  readLocal(
    ...
    chatId = Corncall.getChatId(currentUserNo!, peerNo!);
  ...
  Future uploadFile(bool isthumbnail, {int? timestamp}) async {
    ...
    if (isthumbnail == true) {
      ...
      await _mediaInfo.getMediaInfo(thumbnailFile.path).then((mediaInfo) {
        ...
        Corncall.toast(getTranslated(this.context, 'failedsending'));
    ...
    if (content.trim() != '') {
      ...
      try {
        ...
        // if (encrypted is String) {
          ...
          // _playPopSound();
        // } else {
        //   Corncall.toast('Nothing to encrypt');
        // }
      } on Exception catch (_) {
        // debugPrint('Exception caught!');
        Corncall.toast("Exception: $_");
      }
    }
  }
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .then((chatDoc) async {
                  if (!chatDoc.exists) {
                    Corncall.toast('Please reload this screen !');
              ...
              onTap: () async {
                ...
                if ((mssgDoc.containsKey(Dbkeys.isbroadcast) == true
                  ...
                  await deleteMsgMedia(mssgDoc, chatId!)
                      .then((isDeleted) async {
                    if (isDeleted == false || isDeleted == null) {
                      Corncall.toast('Could not delete. Please try again!');
                    } else {
                      await FirebaseFirestore.instance
                          .collection(DbPaths.collectionmessages)
                          .doc(chatId)
      ...
      tiles.add(Builder(
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () {
                ...
                Corncall.toast(getTranslated(popable, 'copied'));
                Navigator.of(popable).pop();
              })));
    }
    if (((mssgDoc[Dbkeys.from] == currentUserNo &&
    ...
    if (index >= list.length) {
      ...
      if (list[index].containsKey(Dbkeys.groupNAME)) {
        try {
          ...
          Corncall.toast('Failed to send $e');
        }
      } else {
        try {
          ...
          //     isgeneratingSomethingLoader = false;
          //   });
          //   Corncall.toast('Nothing to send');
          // }
        } catch (e) {
          setStateIfMounted(() {
            isgeneratingSomethingLoader = false;
          });
          Corncall.toast('Failed to Forward message. Error:$e');
        }
      }
    }
  }
                          ...
                          Container(
                              child: Row(
                                ...
                                Text(getTranslated(this.context, 'forwarded'),
                                    maxLines: 1,
                                    style: TextStyle(
                                        color: corncallGrey.withOpacity(0.7),
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              ...
              OpenFile.open(
                  Platform.isAndroid
                      ? "/sdcard/download/${message.split('-BREAK-')[1]}"
                      : "${dir!.path}/${message.split('-BREAK-')[1]}",
                  type: getDocumentType(message.split('-BREAK-')[1]));

              print("/sdcard/download/${message.split('-BREAK-')[1]}");
              print(
                "ext:" + message,
              );
            ...
            child: Container(
              decoration: BoxDecoration(
                color: corncallOppositechatcolor.withOpacity(0.3),
              ...
              child: ListTile(
                ...
                leading: Container(
                    ...
                    child: getFileIcon(message.split('-BREAK-')[1])),
                title: InkWell(
                  onTap: () async {
                    var dir = Platform.isAndroid
                        ? await getExternalStorageDirectory()
          ...
          ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (isUser == null || isUser == false) {
                  Corncall.toast(getTranslated(this.context, 'usernotjoined') +
                      ' $Appname');
                }
              },
  ...
  replyAttachedWidget(BuildContext context, var doc) {
    return Flexible(
      child: Container(
          ...
          decoration: BoxDecoration(
              color: corncallWhite.withOpacity(0.55),
          ...
          child: Stack(
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                      color: corncallGrey.withOpacity(0.1),
                        ...
                        children: [
                          ...
                          doc[Dbkeys.messageType] == MessageType.text.index
                              ? Text(
                                  ...
                                  maxLines: 1,
                                  style: TextStyle(color: corncallBlack),
                                )
                              : doc[Dbkeys.messageType] == MessageType.doc.index
                                  ? Container(
      ...
      child: isgeneratingSomethingLoader
          ? Container(
              child: Center(
                child: CircularProgressIndicator(
                    valueColor:
                        AlwaysStoppedAnimation<Color>(corncallPRIMARYcolor)),
              ),
              color: pickTextColorBasedOnBgColorAdvanced(
                      !Thm.isDarktheme(widget.prefs)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(color: corncallGrey, fontSize: 14),
                        )
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(color: corncallGrey),
                        )
                      ],
                    ),
                  ),
    ...
    return Column(
        ...
        children: [
          isReplyKeyboard == true
              ...
              : SizedBox(),
          Container(
            margin: EdgeInsets.only(bottom: Platform.isIOS == true ? 20 : 5),
            child: Row(
              children: <Widget>[
                Flexible(
                  child: Container(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: TextField(
                            ...
                            style:
                                TextStyle(fontSize: 16.0, color: corncallBlack),
                      ...
                      icon: textInSendButton == ""
                          ? new Icon(
                              textEditingController.text.length == 0
                                  ? Icons.mic
                                  : Icons.send,
                              color: corncallWhite.withOpacity(0.99),
                            )
                          : textEditingController.text.length == 0
                              ? new Icon(
                                  Icons.mic,
                  ...
                  child: SizedBox(
                    ...
                    child: EmojiPicker(
                        ...
                        config: Config(
                            ...
                            indicatorColor: corncallPRIMARYcolor,
                            iconColor: Colors.grey,
                            iconColorSelected: corncallPRIMARYcolor,
                            //progressIndicatorColor: Colors.blue,
                            backspaceColor: corncallPRIMARYcolor,
                            recentsLimit: 28,
        ...
        for (final doc in docs.docs) {
          ...
          try {
            ...
            if (e.toString().contains('range')) {
              Corncall.toast(getTranslated(this.context, 'failedtoloadchat'));
              Navigator.of(this.context).pop();
            }
          }
        }
...
//-- GROUP BY DATE ---
              ...
              child: ScopedModelDescendant<DataModel>(
                ...
                return peer != null
                    ? peer![Dbkeys.accountstatus] == Dbkeys.sTATUSdeleted
                        ? Scaffold(
                            backgroundColor: Thm.isDarktheme(widget.prefs)
                                ? corncallCHATBACKGROUNDDarkMode
                                : corncallCHATBACKGROUNDLightMode,
                            appBar: AppBar(
                              backgroundColor: Thm.isDarktheme(widget.prefs)
                                  ? corncallAPPBARcolorDarkMode
                                  : corncallAPPBARcolorLightMode,
                                                                    ...
                                                                    myElevatedButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Map<String, dynamic>
                                                                            ...
                                                                            'id':
                                                                                Corncall.getChatId(currentUserNo!, peerNo!),
                                                                          };
                                                                          ...
                                                                          await FirebaseFirestore
                                                                              ...
                                                                              .then((value) async {
                                                                            showModalBottomSheet(
                                                                                backgroundColor: Thm.isDarktheme(widget.prefs) ? corncallDIALOGColorDarkMode : corncallDIALOGColorLightMode,
                                                                                isScrollControlled: true,
                                                                                context: context,
                                                                                shape: RoundedRectangleBorder(
                                                                                  borderRadius: BorderRadius.vertical(top: Radius.circular(25.0)),
  ...
  deleteAllChats() async {
    if (messages.length > 0) {
      Corncall.toast(getTranslated(this.context, 'deleting'));
      await FirebaseFirestore.instance
          .collection(DbPaths.collectionmessages)
          .doc(chatId)
          .get()
