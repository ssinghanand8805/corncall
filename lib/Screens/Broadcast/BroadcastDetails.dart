...
import 'package:corncall/Screens/Broadcast/EditBroadcastDetails.dart';
            ...
            actions: [
              ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style:
                        TextStyle(color: corncallSECONDARYolor, fontSize: 18),
                  ),
                  onPressed: () {
              ...
              ElevatedButton(
                ...
                child: Text(
                  ...
                  style:
                      TextStyle(color: corncallREDbuttonColor, fontSize: 18),
                ),
                onPressed: () async {
                  Navigator.of(context).pop();
                  setStateIfMounted(() {
