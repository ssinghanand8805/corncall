...
import 'package:corncall/Screens/Broadcast/BroadcastDetails.dart';
...
import 'package:corncall/widgets/DocumentPicker/documentPicker.dart';
...
class _BroadcastChatPageState extends State<BroadcastChatPage>
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .delete();
                Corncall.toast(getTranslated(this.context, 'deleted'));
              })));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: Corncall.getNTPWrappedWidget(Consumer<List<BroadcastModel>>(
