...
import 'package:corncall/Services/Providers/TimerProvider.dart';
...
import 'package:corncall/widgets/PhoneField/intl_phone_field.dart';
import 'package:corncall/widgets/PhoneField/phone_number.dart';
...
class LoginScreenState extends State<LoginScreen>
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      Corncall.toast('Authentication failed + ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      Corncall.toast('Authentication failed Timeout. please try again.');
    };
  ...
  Future<int> generateRandomNumber() async {
    ...
    int min = 0; // Minimum 4-digit number
    int max = 9999; // Maximum 4-digit number
    int idInt = min + random.nextInt(max - min);
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        .collection(DbPaths.collectionusers)
        .where('intUserId', isEqualTo: idInt)
        .get();
      ...
      if (firebaseUser != null) {
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            int idNumeric = await generateRandomNumber();
            print("))))))))))))(((((((((((((((((((((((((${idNumeric}");
            ...
            await widget.prefs.setInt(Dbkeys.intUserId,
                idNumeric ?? 0);
            await FirebaseFirestore.instance
                .collection(DbPaths.collectionusers)
                .doc(phoneNo)
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => CorncallWrapper())));
            Corncall.toast(getTranslated(this.context, 'failedtologin'));
          }
        }
        else {
          ...
          if (fcmToken != null) {
            ...
            try
            {
              ...
              await widget.prefs.setInt(Dbkeys.intUserId,
                  int.parse(documents[0][Dbkeys.intUserId].toString()) ?? 0);
              await subscribeToNotification(documents[0][Dbkeys.phone], false);
              unawaited(Navigator.pushReplacement(
                  this.context,
                  new MaterialPageRoute(
                      builder: (context) => CorncallWrapper())));
              Corncall.toast(getTranslated(this.context, 'welcomeback'));
            }
            catch (e)
    {
      print('*******************${e}');
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => CorncallWrapper())));
            Corncall.toast(getTranslated(this.context, 'failedlogin'));
          }
        }
      } else {
        print('***************');
      ...
      if (e.toString().contains('invalid') ||
        ...
        Corncall.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
  ...
  void _changeLanguage(Language language) async {
    ...
    CorncallWrapper.setLocale(this.context, _locale);
    setState(() {
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Language.languageList().length > 3
                      ? SizedBox(
                          height: 40,
                        )
                      : InkWell(
            ...
            w < h
                ? Image.asset(
                    !Thm.isDarktheme(widget.prefs)
                        ? isDarkColor(corncallAPPBARcolorLightMode)
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: MobileInputWithOutline(
                            buttonhintTextColor: corncallGrey,
                            borderColor: corncallGrey.withOpacity(0.2),
                            controller: _phoneNo,
                      ...
                      Padding(
                        ...
                        child: MySimpleButton(
                          ...
                          spacing: 0.3,
                          height: 57,
                          buttoncolor: corncallSECONDARYolor,
            ...
            child: Padding(
              ...
              child: PinFieldAutoFill(
                ...
                decoration: UnderlineDecoration(
                  bgColorBuilder:
                      FixedColorBuilder(corncallGrey.withOpacity(0.1)),
                  textStyle: TextStyle(
                      fontSize: 22,
                      color: corncallBlack,
                ...
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    Corncall.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6 &&  _code != code) {
          ...
          Padding(
            ...
            child: Text(
              getTranslated(this.context, 'enter_verfcode') +
                  ' $phoneCode-${_phoneNo.text}',
              textAlign: TextAlign.center,
              style: TextStyle(height: 1.5, color: corncallBlack),
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.buttoncolor ?? corncallPRIMARYcolor,
              ),
              borderRadius:
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: widget.hintStyle ??
                      TextStyle(
                          ...
                          fontSize: 15.5,
                          fontWeight: FontWeight.w400,
                          color: widget.buttonhintTextColor ?? corncallGrey),
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 1),
                      borderSide:
                          BorderSide(color: corncallSECONDARYolor, width: 1.5),
                    ),
