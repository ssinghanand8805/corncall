...
class _AuthenticateState extends State<Authenticate> {
      ...
      child = Material(
          ...
          child: Center(
            ...
            child: Text(
              ...
              style:
                  TextStyle(color: corncallWhite, fontSize: 18, height: 1.5),
            ),
          )));
    else {
      child = Container();
    }
    return Corncall.getNTPWrappedWidget(child);
  }
  ...
  _onPasscodeEntered(String enteredPasscode) {
    if (enteredPasscode.length == 4) {
      bool isValid =
          Corncall.getHashedAnswer(enteredPasscode) == widget.passcode;
      ...
      if (isValid) {
        ...
        if (passcodeTries > 3) {
          ...
          Corncall.toast(getTranslated(this.context, 'authfailed'));
          widget.state.pop();
        }
      }
    }
