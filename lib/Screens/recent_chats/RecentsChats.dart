...
import 'package:corncall/Screens/recent_chats/widgets/getBroadcastMessageTile.dart';
import 'package:corncall/Screens/recent_chats/widgets/getGroupMessageTile.dart';
import 'package:corncall/Screens/recent_chats/widgets/getPersonalMessageTile.dart';
...
class RecentChatsState extends State<RecentChats> {
  ...
  buildPersonalMessage(
    ...
    String chatId =
        Corncall.getChatId(currentUserNo!, realTimePeerData[Dbkeys.phone]);
    return streamLoad(
  ...
  Widget build(BuildContext context) {
    ...
    return Corncall.getNTPWrappedWidget(ScopedModel<DataModel>(
      model: getModel()!,
      child:
