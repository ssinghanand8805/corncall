...
import 'package:corncall/Screens/Groups/GroupDetails.dart';
import 'package:corncall/Screens/Groups/widget/groupChatBubble.dart';
...
import 'package:corncall/widgets/InfiniteList/InfiniteCOLLECTIONListViewWidget.dart';
...
//       //----sharing intent action:
                      ...
                      children: [
                        ...
                        Flexible(
                          child: TextField(
                            ...
                            style: TextStyle(
                                fontSize: 16.0, color: corncallBlack),
              ...
              child: GroupChatBubble(
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ? Text(
                        ...
                        style: TextStyle(
                            color: corncallBlack.withOpacity(0.6),
                            fontSize: 15,
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: Corncall.getNTPWrappedWidget(Consumer<List<GroupModel>>(
